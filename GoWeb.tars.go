...
func (_obj *GoWeb) Add(a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWeb) AddWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWeb) AddOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWeb) Sub(a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWeb) SubWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWeb) SubOneWayWithContext(tarsCtx context.Context, a int32, b int32, c *int32, _opt ...map[string]string) (ret int32, err error) {
...
func (_obj *GoWeb) SetServant(s m.Servant) {
	_obj.s = s
}

//TarsSetTimeout sets the timeout for the servant which is in ms.
func (_obj *GoWeb) TarsSetTimeout(t int) {
	_obj.s.TarsSetTimeout(t)
}

//TarsSetProtocol sets the protocol for the servant.
func (_obj *GoWeb) TarsSetProtocol(p m.Protocol) {
	_obj.s.TarsSetProtocol(p)
}

//AddServant adds servant  for the service.
func (_obj *GoWeb) AddServant(imp _impGoWeb, obj string) {
	tars.AddServant(_obj, imp, obj)
}

//AddServant adds servant  for the service with context.
func (_obj *GoWeb) AddServantWithContext(imp _impGoWebWithContext, obj string) {
	tars.AddServantWithContext(_obj, imp, obj)
}

type _impGoWeb interface {
	Add(a int32, b int32, c *int32) (ret int32, err error)
	Sub(a int32, b int32, c *int32) (ret int32, err error)
}
type _impGoWebWithContext interface {
...
func (_obj *GoWeb) Dispatch(tarsCtx context.Context, _val interface{}, tarsReq *requestf.RequestPacket, tarsResp *requestf.ResponsePacket, _withContext bool) (err error) {
	var length int32
	var have bool
	var ty byte
	...
	case "Add":
		...
		if _withContext == false {
			...
			_imp := _val.(_impGoWebWithContext)
